...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-[#f2efe4] font-['Rubik'] max-w-[375px] mx-auto">
      ...
      {/* Profile Section - thu nhỏ lại */}
      <div className="flex flex-col items-center px-6 pt-6 pb-8">
        {/* Avatar - thu nhỏ */}
        <div className="w-[80px] h-[80px] rounded-[16px] bg-[#e9e4d6] flex items-center justify-center mb-4">
          {user.user_metadata?.avatar_url ? (
            ...
            <div className="w-[52px] h-[52px] rounded-full bg-[#403e39] flex items-center justify-center">
        ...
        <div className="text-center">
          <h2 className="text-[20px] font-medium text-[#262521] leading-[24px] mb-1">
            {user.user_metadata?.name || user.user_metadata?.full_name || user.email?.split('@')[0] || 'User'}
          </h2>
          <p className="text-[14px] text-[#403e39] leading-[18px]">
